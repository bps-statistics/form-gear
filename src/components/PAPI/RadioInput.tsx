...
const RadioInput: FormComponentBase = props => {
	...
	return (
		<InputContainer component={props.component} optionSection={optionSection}>
	...
	return (
		<div class='grid md:grid-cols-8 p-2 border-b border-gray-300/[.40] dark:border-gray-200/[.10]'>
			...
			<Show when={props.validationMessage.length > 0 && !props.isNestedInput}>
